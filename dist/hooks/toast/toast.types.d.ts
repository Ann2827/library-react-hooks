 ...
 */
export declare type ToastTypes = 'error' | 'warning' | 'info' | 'success';
export declare type ToastDataObject = {
    id: number;
 ...
 */
export declare type ToastPropsT = Omit<Omit<ToastDataObject, 'id'>, 'icon'> & {
    duration?: number;
    sticky?: boolean;
};
